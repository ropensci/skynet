...
download_t100 <- function(y = NULL, type = NULL){
  ...
  httr::POST(
    ...
    httr::add_headers(
      Referer = "https://www.transtats.bts.gov/DL_SelectFields.asp?Table_ID=258"
    ),
    body = list(
      UserTableName = "T_100_Domestic_Market__U.S._Carriers",
      DBShortName = "", RawDataTable = "T_T100D_MARKET_US_CARRIER_ONLY",
  ...
  if(type == "seg"){
    httr::POST(
      url = "https://www.transtats.bts.gov/DownLoad_Table.asp",
      httr::add_headers(
        Referer = "https://www.transtats.bts.gov/DL_SelectFields.asp?Table_ID=259"
      ),
     body = list(
